        ...
        <div>
            <Form className="d-grid gap-2" style={{ margin: "15rem" }}>
                <Form.Group className="nb-3" controlId="formTitle">
                    <Form.Control type="text" placeholder="Enter Title" value={title} required onChange={(e) => setTitle(e.target.value)} readOnly>
                    </Form.Control>
                </Form.Group>
                ...
                <Form.Group className="nb-3" controlId="formBackground">
                    <Form.Control type="text" placeholder="Enter Story" value={background} required onChange={(e) => setBackground(e.target.value)} readOnly>
                    </Form.Control>
                </Form.Group>
                <table>
                    <tr>
